                ...
                <div className='container mt-5'>
                    {isVisible ? (
                        <div className='row'>
                            ...
                            <div className='col-lg-3 col-sm-12 col-md-12'>
                                <div className='   '>
                                    <di className="card-bg-AB position-relative d-flex justify-content-center">
                                        {/* BG IMAGES */}
                                        <img src={t2} />
                                        {/* <h1></h1> */}
                                    ...
                                    <div className='   '>
                                        ...
                                        <div className='text-div'>
                                            ...
                                            {/* <div className='d-flex justify-content-start '>
                                                ...
                                                <i class="fa-solid fa-arrow-right text-danger ms-2 mt-1"></i>
                                            </div> */}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className='   '>
                                        ...
                                        <div className='text-div'>
                                            ...
                                            {/* <div className='d-flex justify-content-start mt-5 pt-4 '>
                                                <p className='text-danger fs-6'>View infographic</p>
                                                <i class="fa-solid fa-arrow-right text-danger ms-2 " ></i>
                                            </div> */}
                                        </div>
                                    </div>
                                </div>
